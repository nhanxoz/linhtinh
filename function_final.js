var lesson_kid = !1;
$.getScript("https://raw.githubusercontent.com/nhanxoz/linhtinh/master/tienganh123.js", function() {
...
$(document).ready(function() {
    ...
    $("#translate_button,#translate_button_1").live("click", function() {
        ...
        "" != o && (0 == dk && 1 == $("#box_nonvip").length && ($("#box_nonvip").hide(),
        t = 1),
        $("span[onmouseover*='showmessage']").hover(function() {
            hien_dich_times >= 3 && 1 == dk && 1 == t && ($("#box_nonvip").length < 1 && $("body").append(o),
